  ...
  return (
    <main className="bg-about-canvas">
      ...
      >
        ...
        <div className="absolute inset-0 z-10 flex items-end pb-[14vw] sm:items-center sm:pb-0">
          <div className="max-w-[62%] px-5 sm:max-w-md sm:px-10 lg:max-w-lg lg:px-14">
